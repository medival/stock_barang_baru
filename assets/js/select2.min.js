...
!function(n) {
  ...
  var e = function() {
    ...
    return e && e.requirejs ||
               (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {},
                i = Object.prototype.hasOwnProperty, a = [].slice, b = /\.js$/,
                f =
                    function(e, t) {
                      var n, r = c(e), i = r[0], o = t[1];
                      return e = r[1], i && (n = D(i = l(i, o))),
                             i ? e = n && n.normalize
                                         ? n.normalize(
                                               e,
                                               function(t) {
           ...
           e.define(
               ...
               function(o) {
                 ...
                 function u(e) {
                   var t = e.prototype, n = [];
                   for (var r in t) {
                     "function" == typeof t[r] && "constructor" !== r &&
                         n.push(r)
                   }
                   return n
                 }
                 i.Extend = function(e, t) {
                   ...
                   for (var i in t)
                     n.call(t, i) && (e[i] = t[i]);
                   return r.prototype = t.prototype, e.prototype = new r,
                 ...
                 return i.GetUniqueElementId = function(e) {
                   ...
                   return t ? i.__cache[n] && null != i.__cache[n][t]
                                  ? i.__cache[n][t]
                                  : o(e).data(t)
                            : i.__cache[n]
                 ...
                 return f.Extend(r, f.Observable), r.prototype.render = function() {
                   ...
                   if (0 !== e.length) {
                     var t = this.$results.find("[aria-selected]").index(e),
                         n = this.$results.offset().top, r = e.offset().top,
                   ...
                   var n = this.options.get("templateResult"),
                       r = this.options.get("escapeMarkup"), i = n(e, t);
                   null == i              ? t.style.display = "none"
                   : "string" == typeof i ? t.innerHTML = r(i)
                                          : h(t).append(i)
                 }, r
               }),
                   ...
                   n(document.body)
                       .on("mousedown.select2." + e.id, function(e) {
                         ...
                         n(".select2.select2-container--open").each(function() {
                           this != t[0] &&
                               r.GetData(this, "element").select2("close")
                         })
                       })
                 ...
                 return l.Extend(n, e), n.prototype.render = function() {
                   ...
                   n.__super__.bind.apply(this, arguments),
                       this.$selection.on(
                           "click",
                           function(
                               e) { r.trigger("toggle", {originalEvent : e}) }),
                       this.$selection.on(
                   ...
                   if (this.clear(), 0 !== e.length) {
                     for (var t = [], n = 0; n < e.length; n++) {
                       var r = e[n], i = this.selectionContainer(),
                           o = this.display(r, i);
                       i.append(o);
                       var s = r.title || r.text;
                       s && i.attr("title", s), l.StoreData(i[0], "data", r),
                           t.push(i)
                     }
                     var a =
                         this.$selection.find(".select2-selection__rendered");
               ...
               function(i, r, a) {
                 ...
                 return e.prototype.bind = function(e, t, n) {
                   ...
                   e.call(this, t, n),
                       ...
                       t.on("keypress",
                            function(e) { r._handleKeyboardClear(e, t) })
                     ...
                     if (0 !== n.length) {
                       ...
                       if (this.trigger("clear", o), o.prevented)
                         ...
                         for (var s = 0; s < r.length; s++)
                           if (o = {data : r[s]}, this.trigger("unselect", o),
                               o.prevented)
               ...
               function(r, a, l) {
                 ...
                 return e.prototype.render = function(e) {
                   ...
                   e.call(this, t, n),
                       ...
                       t.on("disable",
                            function() { r.$search.prop("disabled", !0) }),
                       t.on("focus",
                            function(e) { r.$search.trigger("focus") }),
                       t.on("results:focus",
                            function(e) {
                              e.data._resultId
                                  ? r.$search.attr("aria-activedescendant",
                                                   e.data._resultId)
                                  : r.$search.removeAttr(
                       ...
                       this.$selection.on(
                           ...
                           function(e) { r.trigger("focus", e) }),
                       this.$selection.on("focusout", ".select2-search--inline",
                                          function(e) { r._handleBlur(e) }),
                       this.$selection.on(
                           "keydown", ".select2-search--inline",
                           function(e) {
                             if (e.stopPropagation(), r.trigger("keypress", e),
                       ...
                       this.$selection.on(
                           ...
                           function(
                               e) { r.$search.val() && e.stopPropagation() });
                   var o = document.documentMode, s = o && o <= 11;
                   this.$selection.on(
                       "input.searchcheck", ".select2-search--inline",
                       function(e) {
                         s ? r.$selection.off("input.search input.searchcheck")
               ...
               function(e, a, l) {
                 ...
                 return a.Extend(n, e), n.prototype.current = function(e) {
                   ...
                   if (e.is("option"))
                     ...
                     for (var n = e.children("option"), r = [], i = 0;
                          i < n.length; i++) {
                    ...
                    function(e, f, g) {
                      ...
                      return f.Extend(r, e), r.prototype.bind = function(e, t) {
                        ...
                        var t = this, n = this.$element.find("option"),
                            r = n.map(function() { return t.item(g(this)).id })
                                    .get(),
                            i = [];
                        function o(e) {
                   ...
                   function e() {
                     var e = t.transport(
                         ...
                         function(e) {
                           ...
                           i.options.get("debug") && window.console &&
                               console.error &&
               ...
               function(u) {
                 function e(e, t, n) {
                   ...
                   if (void 0 !== o && (this.insertTag = o), e.call(this, t, n),
                       u.isArray(r))
                     for (var s = 0; s < r.length; s++) {
                       var a = r[s], l = this._normalizeItem(a),
                           c = this.option(l);
                 ...
                 return e.prototype.bind = function(e, t, n) {
                   ...
                   var i = this.tokenizer(t, this.options, function(e) {
                     ...
                     if (!r.$element.find("option")
                              ...
                              .length) {
                       var n = r.option(t);
                       n.attr("data-select2-tag", !0), r._removeOldTags(),
                           r.addOptions([ n ])
                     }
                     !function(e) { r.trigger("select", {data : e}) }(t)
                   });
                   i.term !== t.term &&
                       (this.$search.length && (this.$search.val(i.term),
                                                this.$search.trigger("focus")),
                        t.term = i.term),
                       e.call(this, t, n)
                 }, e.prototype.tokenizer = function(e, t, n, r) {
                   for (var i = n.get("tokenSeparators") || [], o = t.term,
                            s = 0,
                            a = this.createTag ||
                                function(e) {
           ...
           e.define(
               ...
               function() {
                 ...
                 return e.prototype.bind = function(e, t, n) {
                   ...
                   e.call(this, t, n),
                       t.on("select",
                            function() { r._checkIfMaximumSelected() })
                 }, e.prototype.query = function(e, t, n) {
                   var r = this;
                 ...
                 return t.prototype.render = function(e) {
                   ...
                   e.call(this, t, n),
                       ...
                       this.$search.on("keyup input",
                                       function(e) { r.handleSearch(e) }),
                       t.on("open", function() {
                         r.$search.attr("tabindex", 0),
                             r.$search.attr("aria-controls", i),
                             r.$search.trigger("focus"),
                             window.setTimeout(
                                 function() { r.$search.trigger("focus") }, 0)
                       }), t.on("close", function() {
                         ...
                         null != e.query.term && "" !== e.query.term ||
                             (r.showSearch(e) ? r.$searchContainer.removeClass(
                                                    "select2-search--hide")
           ...
           e.define(
               ...
               function(n) {
                 function e(e, t, n, r) {
                   this.lastParams = {}, e.call(this, t, n, r),
                 ...
                 return e.prototype.append = function(e, t) {
                   ...
                   e.call(this, t, n),
                       t.on("query",
                            function(e) { r.lastParams = e, r.loading = !0 }),
                       t.on("query:append",
                            function(e) { r.lastParams = e, r.loading = !0 }),
           ...
           e.define(
               ...
               function(f, a) {
                 ...
                 return e.prototype.bind = function(e, t, n) {
                   ...
                   var n = this, r = "scroll.select2." + t.id,
           ...
           e.define("select2/dropdown/selectOnClose", [ "../utils" ],
                    function(o) {
                      ...
                      return e.prototype.bind = function(e, t, n) {
                        ...
                        e.call(this, t, n),
                            t.on("close",
                                 function(e) { r._handleSelectOnClose(e) })
           ...
           e.define(
               ...
               function() {
                 ...
                 return e.prototype.bind = function(e, t, n) {
                   var r = this;
                   e.call(this, t, n),
                       t.on("select", function(e) { r._selectTriggered(e) }),
           ...
           e.define(
               ...
               function(c, u, d, p, h, f, g, m, v, y, s, t, _, $, b, w, A, x, D,
                        S, E, C, O, T, q, L, I, j, e) {
                 function n() { this.reset() }
                 return n.prototype.apply = function(e) {
                   if (null ==
                       (e = c.extend(!0, {}, this.defaults, e)).dataAdapter) {
                     if (null != e.ajax   ? e.dataAdapter = b
                         : null != e.data ? e.dataAdapter = $
                                          : e.dataAdapter = _,
                         ...
                         e.tags &&
                             (e.dataAdapter = y.Decorate(e.dataAdapter, w)),
                   ...
                   if (null == e.resultsAdapter &&
                     ...
                     if (0 !== e.minimumResultsForSearch &&
                             (e.dropdownAdapter =
                                  y.Decorate(e.dropdownAdapter, L)),
                   ...
                   var n = e.language, r = this.defaults.language,
                       i = t.prop("lang"), o = t.closest("[lang]").prop("lang"),
                       s = Array.prototype.concat.call(
                           this._resolveLanguage(i), this._resolveLanguage(n),
                           this._resolveLanguage(r), this._resolveLanguage(o));
           ...
           e.define(
               ...
               function(i, e, o, t, s) {
                 ...
                 return null == i.fn.select2.defaults &&
