...
(function(e, t) {
  ...
  function v(e, t, r, p) {
    ...
    if ('viewport' === p)
      ...
      : 'window' === p ? f = e.ownerDocument.documentElement
                       : f = p;
      var m = b(f, l, s);
      if ('HTML' === f.nodeName && !y(l)) {
        var h = c(e.ownerDocument), g = h.height, u = h.width;
        d.top += m.top - m.marginTop, d.bottom = g + m.top,
    ...
    return d.left += v ? r : r.left || 0, d.top += v ? r : r.top || 0,
           d.right -= v ? r : r.right || 0, d.bottom -= v ? r : r.bottom || 0, d
  }
  function x(e) {
  ...
  function O(e, t, o, n, i) {
    ...
    var p = v(o, n, r, i), s = {
      ...
      left : {width : t.left - p.left, height : p.height}
        ...
        d = Object.keys(s)
                .map(function(
                    e) { return le({key : e}, s[e], {area : x(s[e])}) })
                 ...
                 return p.forEach(function(s, d) {
                   ...
                   var a = e.offsets.popper, l = e.offsets.reference, f = Z,
                       ...
                       E = !!t.flipVariationsByContent &&
                           (w && 'start' === r && c || w && 'end' === r && h ||
                            !w && 'start' === r && u || !w && 'end' === r && g),
                       v = y || E;
                   (m || b || v) &&
                       (e.flipped = !0, (m || b) && (n = p[d + 1]),
                        v && (r = z(r)), e.placement = n + (r ? '-' + r : ''),
                        e.offsets.popper =
                            le({}, e.offsets.popper,
