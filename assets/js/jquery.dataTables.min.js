...
$jscomp.getGlobal = function(f) {
  return "undefined" != typeof window && window === f     ? f
...
function W(a) {
  ...
  f.each(
      a.aoColumns,
      function(a,
               d) { d.bVisible && "none" !== f(d.nTh).css("display") && b++; });
  return b;
}
function oa(a, b) {
  var c = [];
  ...
  var w = function(a, b) {
    ...
    if (c === p || c === k)
      (g = n[k]), (l = f.trim(a.innerHTML)),
          g && g._bAttrSrc ? (Q(g.mData._)(d, l), w(g.mData.sort, a),
                              w(g.mData.type, a), w(g.mData.filter, a))
...
function S(a) {
  ...
  if (-1 !== f.inArray(!1, b))
    ...
    a.bDrawing = !0;
    g !== p && -1 !== g &&
        ((a._iDisplayStart = k                           ? g
                             : g >= a.fnRecordsDisplay() ? 0
                                                         : g),
    ...
    if (0 !== l.length)
      ...
      (c = h.sZeroRecords),
          1 == a.iDraw && "ajax" == D(a)
              ? (c = h.sLoadingRecords)
              : h.sEmptyTable && 0 === a.fnRecordsTotal() &&
                    (c = h.sEmptyTable),
          (b[0] = f("<tr/>", {
                    class : e ? d[0] : ""
                  }).append(f("<td />", {
...
function va(a, b, c) {
  ...
  a.fnServerData
      ? a.fnServerData.call(
            g, a.sAjaxSource,
            f.map(b, function(a, b) { return {name : b, value : a}; }), k, a)
...
function qb(a) {
  return a.bAjaxDataGet ? (a.iDraw++, K(a, !0),
                           va(a, zb(a), function(b) { Ab(a, b); }), !1)
                        : !0;
}
function zb(a) {
...
function Xa(a, b, c) {
  ...
  0 === h || -1 === e     ? (d = 0)
  : "number" === typeof b ? ((d = b * e), d > h && (d = 0))
  : "first" == b          ? (d = 0)
  : "previous" == b       ? ((d = 0 <= e ? d - e : 0), 0 > d && (d = 0))
  : "next" == b           ? d + e < h && (d += e)
  : "last" == b           ? (d = Math.floor((h - 1) / e) * e)
...
function N(a, b, c) {
  for (var d = 0, e = 0, h = b.length, g, k; e < h;) {
    ...
    for (k = c ? c[e].firstChild : null; g;)
      1 === g.nodeType && (c ? a(g, k, d) : a(g, d), d++), (g = g.nextSibling),
...
function Ja(a) {
  ...
  if (d || (!u && !h && !e && k == W(a) && k == n.length))
    ...
    for (q = 0; q < l.length; q++)
      (r = c[l[q]]),
          (n[q].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig
                                  ? B(r.sWidthOrig)
                                  : ""),
...
function Za(a, b, c, d) {
  ...
  c && a.oFeatures.bSortMulti
      ? ((c = f.inArray(b, J(e, "0"))),
         -1 !== c ? ((b = g(e[c], !0)), null === b && 1 === e.length && (b = 0),
                     null === b ? e.splice(c, 1)
...
function M(a, b, c, d) {
  f.isArray(c)
      ? f.each(
            c,
            function(c, d) { f.isArray(d) ? M(a, b, d[0], d[1]) : M(a, b, d); })
...
function ab(a, b, c) {
  ...
  for (d in b)
    if (b.hasOwnProperty(d)) {
      ...
      : c && "data" !== d && "aaData" !== d && f.isArray(e) ? (a[d] = e.slice())
                                                            : (a[d] = e);
    }
  return a;
}
...
function Ra(a, b) {
  ...
  return f.isPlainObject(a) && a[b] ? c[a[b]] || c._
         : "string" === typeof a    ? c[a] || c._
                                    : c._;
}
function D(a) {
  return a.oFeatures.bServerSide   ? "ssp"
         : a.ajax || a.sAjaxSource ? "ajax"
                                   : "dom";
}
function ka(a, b) {
...
var q =
  ...
  this.each(function() {
    ...
    if ("table" != this.nodeName.toLowerCase())
      ...
      -1 !== f.inArray(!0,
                       f.map(e, function(a, b) { return z.hasClass(a); })) &&
...
f.extend(v.prototype, {
  ...
  iterator : function(a, b, c, d) {
    ...
    return e.length || d ? ((a = new v(f, a ? e.concat.apply([], e) : e)),
                            (b = a.selector), (b.rows = n.rows),
                            (b.cols = n.cols), (b.opts = n.opts), a)
                         : this;
  },
...
v.registerPlural = x = function(a, b, c) {
  ...
  v.register(b, function() {
    ...
    return a === this ? this
           : a instanceof v
               ? a.length ? f.isArray(a[0]) ? new v(a.context, a[0]) : a[0] : p
               : a;
  });
};
var fc = function(a, b) {
...
t("ajax.reload()", function(a, b) {
  return this.iterator("table", function(c) { Xb(c, !1 === b, a); });
});
t("ajax.url()", function(a) {
  ...
  return this.iterator(
      "table",
      function(
          b) { f.isPlainObject(b.ajax) ? (b.ajax.url = a) : (b.ajax = a); });
});
...
t("rows().nodes()", function() {
  return this.iterator("row", function(a, b) { return a.aoData[b].nTr || p; },
                       1);
});
...
x("rows().invalidate()", "row().invalidate()",
  function(
      a) { return this.iterator("row", function(b, c) { ea(b, c, a); }); });
...
var jc = /^([^:]+):(name|visIdx|visible)$/, Zb = function(a, b, c, d, e) {
  ...
  return eb("column", b, function(b) {
    ...
    if ("function" === typeof b) {
      ...
      return f.map(
          d,
          function(c, d) { return b(d, Zb(a, d, 0, 0, l), h[d]) ? d : null; });
    }
...
x("cells().indexes()", "cell().index()", function() {
  return this.iterator(
      "cell",
      function(a, b,
               c) { return {row : b, column : c, columnVisible : ca(a, c)}; },
      1);
});
...
f.extend(C.type.order, {
  ...
  "html-pre" : function(a) {
    return P(a)        ? ""
           : a.replace ? a.replace(/<.*?>/g, "").toLowerCase()
                       : a + "";
  },
  ...
  "string-asc" : function(a, b) { return a < b   ? -1
                                         : a > b ? 1
                                                 : 0; },
  "string-desc" : function(a, b) { return a < b   ? 1
                                          : a > b ? -1
                                                  : 0; },
});
Ha("");
  ...
  number : function(a, b, c, d, e) {
    return {
      display : function(f) {
        ...
        return (g + (d || "") +
                h.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + f +
                (e || ""));
      },
    };
  },
