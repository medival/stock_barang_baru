...
$jscomp.polyfill("Array.prototype.find", function(a) {
  return a ? a : function(a, g) { return $jscomp.findInternal(this, a, g).v }
}, "es6", "es3");
(function(a) {
"function" === typeof define && define.amd
    ? define([ "jquery", "datatables.net" ],
             function(k) { return a(k, window, document) })
...
a.extend(m.prototype, {
  _constructor : function() {
    ...
    !1 !== c.type && (b._detailsInit(),
                      ...
                      d.on("draw.dtr", function() { b._redrawChildren() }),
    ...
    d.on("preXhr.dtr", function() {
      var a = [];
      d.rows().every(
          function() { this.child.isShown() && a.push(this.id(!0)) });
    ...
    d.on("draw.dtr", function() { b._controlClass() })
        .on("init.dtr", function(c, e, r) {
          "dt" === c.namespace &&
              (b._resizeAuto(), b._resize(),
               a.inArray(!1, b.s.current) && d.columns.adjust())
        });
    this._resize()
  },
  _columnsVisiblity : function(b) {
    var d = this.s.dt, c = this.s.columns, e,
        ...
        l = a.map(c, function(c, h) {
          return !1 === d.column(h).visible()    ? "not-visible"
                 : c.auto && null === c.minWidth ? !1
                 : !0 === c.auto                 ? "-"
  ...
  _classLogic : function() {
    var b = this, d = this.c.breakpoints, c = this.s.dt,
        e = c.columns().eq(0).map(function(a) {
          ...
          return {
            className: d, includeIn: [], auto: !1, control: !1,
                never: d.match(/\bnever\b/) ? !0 : !1, priority: a
          }
        }),
        f = function(b, d) {
          b = e[b].includeIn;
    ...
    e.each(function(b, c) {
      for (var e = b.className.split(" "), f = !1, h = 0, l = e.length; h < l;
           h++) {
        var k = a.trim(e[h]);
        if ("all" === k) {
          f = !0;
        ...
        a.each(d, function(b, a) {
          b = a.name.split("-");
          var d = k.match(new RegExp("(min\\-|max\\-|not\\-)?(" + b[0] +
                                     ")(\\-[_a-zA-Z0-9])?"));
          d && (f = !0, d[2] === b[0] && d[3] === "-" + b[1]
  ...
  _controlClass : function() {
    if ("inline" === this.c.details.type) {
      ...
      b.cells(null, function(b) { return b !== d }, {page : "current"})
          .nodes()
          .to$()
          .filter(".dtr-control")
  ...
  _detailsDisplay : function(b, d) {
    ...
    if (f && !1 !== f.type) {
      var g = f.display(
          b, d, function() { return f.renderer(e, b[0], c._detailsObj(b[0])) });
      !0 !== g && !1 !== g ||
  ...
  _detailsInit : function() {
    ...
    if (e !== n || null !== e)
      a(d.table().body())
          .on("click.dtr mousedown.dtr mouseup.dtr", c, function(c) {
            if (a(d.table().node()).hasClass("collapsed") &&
                -1 !== a.inArray(a(this).closest("tr").get(0),
              ...
              "click" === c.type       ? b._detailsDisplay(f, !1)
              : "mousedown" === c.type ? a(this).css("outline", "none")
                                       : "mouseup" === c.type &&
                                             a(this).trigger("blur").css(
                                                 "outline", "")
            }
          })
  },
    ...
    return a.map(this.s.columns, function(e, f) {
      if (!e.never && !e.control)
        return e = c.settings()[0].aoColumns[f], {
          className: e.sClass, columnIndex: f,
              data: c.cell(b, f).render(d.c.orthogonal),
              hidden: c.column(f).visible() && !d.s.current[f], rowIndex: b,
              title: null !== e.sTitle ? e.sTitle
  ...
  _resize : function(b) {
    var d = this, c = this.s.dt, e = a(k).innerWidth(), f = this.c.breakpoints,
        g = f[0].name, r = this.s.columns, h, n = this.s.current.slice();
    ...
    for (e = r.length; h < e; h++)
      if (!1 === m[h] && !r[h].never && !r[h].control &&
    ...
    c.columns().eq(0).each(function(a, c) {
      !0 === m[c] && q++;
      if (b || m[c] !== n[c])
        p = !0, d._setColumnVis(a, m[c])
    });
    p && (this._redrawChildren(),
          a(c.table().node())
              .trigger("responsive-resize.dt", [ c, this.s.current ]),
  ...
  _resizeAuto : function() {
    ...
    if (this.c.auto &&
        -1 !== a.inArray(!0, a.map(d, function(b) { return b.auto }))) {
      ...
      var g = b.columns()
                  .header()
                  .filter(function(a) { return b.column(a).visible() })
                  .to$()
                  .clone(!1)
                  .css("display", "table-cell")
                  .css("width", "auto")
                  .css("min-width", 0);
      a(f).append(a(b.rows({page : "current"}).nodes()).clone(!1))
          .find("th, td")
          .css("display", "");
      if (f = b.table().footer()) {
  ...
  _responsiveOnlyHidden : function() {
    ...
    return a.map(
        this.s.current,
        function(a, c) { return !1 === b.column(c).visible() ? !0 : a })
  },
  _setColumnVis : function(b, d) {
    ...
    a.isEmptyObject(q) ||
        c.cells(null, b).indexes().each(function(a) { v(c, a.row, a.column) })
  },
  _tabIndexes : function() {
    var b = this.s.dt, d = b.cells({page : "current"}).nodes().to$(),
        c = b.settings()[0], e = this.c.details.target;
    d.filter("[data-dtr-keyboard]").removeData("[data-dtr-keyboard]");
    "number" === typeof e ? b.cells(null, e, {page : "current"})
                                .nodes()
                                .to$()
            ...
            k = a('<div class="dtr-modal"/>')
                    .append(
                        a('<div class="dtr-modal-display"/>')
                            .append(a('<div class="dtr-modal-content"/>')
                                        .append(e()))
                            .append(
                                a('<div class="dtr-modal-close">&times;</div>')
                                    .click(function() { f() })))
                    .append(a('<div class="dtr-modal-background"/>')
                                .click(function() { f() }))
                    .appendTo("body");
        a(g).on("keyup.dtr",
  ...
  listHiddenNodes : function() {
    return function(b, d, c) {
      ...
      a.each(c, function(c, d) {
        d.hidden &&
            (a("<li " + (d.className ? 'class="' + d.className + '"' : "") +
               ' data-dtr-index="' + d.columnIndex + '" data-dt-row="' +
               d.rowIndex + '" data-dt-column="' + d.columnIndex +
               '"><span class="dtr-title">' + d.title + "</span> </li>")
                 .append(a('<span class="dtr-data"/>')
                             .append(p(b, d.rowIndex, d.columnIndex)))
                 .appendTo(e),
             f = !0)
      });
      return f ? e : !1
    ...
    return function(b, d, c) {
      return (b = a.map(c,
                        function(a) {
                          ...
                          return a.hidden
                                     ? "<li " + b + ' data-dtr-index="' +
                                           a.columnIndex + '" data-dt-row="' +
                                           a.rowIndex + '" data-dt-column="' +
                                           a.columnIndex +
                      ...
                      .join(""))
                 ? a('<ul data-dtr-index="' + d + '" class="dtr-details"/>')
                       .append(b)
                 : !1
    }
  },
  tableAll : function(b) {
    ...
    return function(d, c, e) {
      d = a.map(e, function(a) {
             return "<tr " +
                    (a.className ? 'class="' + a.className + '"' : "") +
                    ' data-dt-row="' + a.rowIndex + '" data-dt-column="' +
                    a.columnIndex + '"><td>' + a.title + ":</td> <td>" +
                    a.data + "</td></tr>"
           }).join("");
      return a('<table class="' + b.tableClass + ' dtr-details" width="100%"/>')
          .append(d)
    }
  }
};
...
a(g).on("preInit.dt.dtr", function(b, d, c) {
  "dt" === b.namespace &&
      (a(d.nTable).hasClass("responsive") ||
       a(d.nTable).hasClass("dt-responsive") || d.oInit.responsive ||
