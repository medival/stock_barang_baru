...
CREATE TABLE `ci_sessions` (
    ...
    `data` blob NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;

--
-- Dumping data for table `ci_sessions`
--
INSERT INTO `ci_sessions` (`id`, `ip_address`, `timestamp`, `data`)
    VALUES ('mendrn4q8omvgjukvma8aaega0b6j4ca', '::1', 1664877674, 0x5f5f63695f6c6173745f726567656e65726174657c693a313636343837373637343b5573657249447c733a313a2231223b557365727c733a31323a22526f62696e2049726177616e223b6c6576656c7c733a353a2261646d696e223b666f746f7c733a31383a22666f746f313635323639323537332e706e67223b),
...
CREATE TABLE `tbl_barang` (
    ...
    `active` enum ('Y', 'N') NOT NULL DEFAULT 'Y') ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;

--
-- Dumping data for table `tbl_barang`
--
INSERT INTO `tbl_barang` (`kode_barang`, `nama_barang`, `brand`, `stok`, `harga`, `active`)
    VALUES ('ADNAPS', 'Advan NASA Plus', 'Advan', 10, 770000, 'Y'),
...
CREATE TABLE `tbl_detail_pembelian` (
    ...
    `harga` double NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;

--
-- Triggers `tbl_detail_pembelian`
--
DELIMITER $$
CREATE TRIGGER `pembelian_barang`
    AFTER INSERT ON `tbl_detail_pembelian`
    FOR EACH ROW
BEGIN
    UPDATE tbl_barang b SET b.stok = b.stok + new.qty
WHERE
    b.kode_barang = new.id_barang;
...
CREATE TRIGGER `update_pembelian`
    AFTER DELETE ON `tbl_detail_pembelian`
    FOR EACH ROW
BEGIN
    UPDATE tbl_barang b SET b.stok = b.stok - old.qty
WHERE
    b.kode_barang = old.id_barang;
...
CREATE TRIGGER `penjualan_barang`
    AFTER INSERT ON `tbl_detail_penjualan`
    FOR EACH ROW
BEGIN
    UPDATE tbl_barang b SET b.stok = b.stok - new.qty
WHERE
...
CREATE TRIGGER `update_penjualan`
    AFTER DELETE ON `tbl_detail_penjualan`
    FOR EACH ROW
BEGIN
    UPDATE tbl_barang b SET b.stok = b.stok + old.qty
WHERE
...
CREATE TABLE `tbl_pembelian` (
    ...
    `id_user` int(11) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `tbl_supplier` (
    ...
    `telp` varchar(20) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE `tbl_user` (
    ...
    `last_login` datetime DEFAULT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;

--
-- Dumping data for table `tbl_user`
--
INSERT INTO `tbl_user` (`id_user`, `username`, `fullname`, `password`, `alamat`, `hp`, `foto`, `level`, `active`, `last_login`)
    VALUES (1, 'Linda', 'Linda Saputri', '$2y$08$BO41OJFfhPPPzjKdWw2I6OyUElK1mkD43UVt1ss6J1xrVUExC1lRy', 'Pulau Sabira', '082114504970', 'default.jpeg', 'admin', 'Y', '2022-10-05 12:00:46');
...
--
ALTER TABLE `tbl_user` MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT = 9;
