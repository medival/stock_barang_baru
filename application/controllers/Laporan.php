...
class Laporan extends CI_Controller
{
    ...
    public function labarugiharian()
    {
        //cek login
        $this->is_login();
        ...
        $this->template->kasir('laporan/labarugiharian', $data);
    }

    public function labarugihariancetak($date)
    {
        $this->is_login();
        ...
        $this->template->cetak('cetak/labarugihariancetak', $data);
    }
    ...
    public function labarugibulanan()
    {
        ...
        $data = [
            ...
            'bulan' => $bulan,
            'tahun' => $tahun,
            'month' => $this->convert_bulan($bulan),
            'year' => $tahun,
        ];

        $this->template->kasir('laporan/labarugibulanan', $data);
    }

    public function labarugibulanancetak($date)
    {
        $this->is_login();
        //explode url
        $exp = explode('-', $date);
        ...
        $data = [
            ...
            'bulan' => $exp[0],
            'tahun' => $exp[1],
            'month' => $this->convert_bulan($exp[0]),
            'year' => $exp[1],
        ];

        $this->template->cetak('cetak/labarugibulanancetak', $data);
    }
}
