...
<nav id="sidebar">
    <div class="p-4 pt-5 bg-info">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/logoapk.jpeg'); ?>);"></a>
        <ul class="list-unstyled components mb-5">
            ...
            <!-- <li <?= (in_array(strtolower($this->uri->segment(2)), ['labarugiharian', 'labarugibulanan'])) ? 'class="active"' : ''; ?>>
                <a href="#pagelaporanlabarugi" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-file-text-o"></i> Laporan Laba & Rugi</a>
                <ul class="collapse list-unstyled" id="pagelaporanlabarugi">
                    <li <?= (strtolower($this->uri->segment(1)) == 'labarugiharian') ? 'class="active"' : ''; ?>>
                        <a href="<?= site_url('laporan/labarugiharian'); ?>">
                            <i class="fa fa-angle-double-right"></i> Harian
                        </a>
                    </li>
                    <li <?= (strtolower($this->uri->segment(1)) == 'labarugibulanan') ? 'class="active"' : ''; ?>>
                        <a href="<?= site_url('laporan/labarugibulanan'); ?>">
                            <i class="fa fa-angle-double-right"></i> Bulanan
                        </a>
                    </li>
                </ul>
