...
<div class="col-md-8">
    <div class="form-group row">
        <label for="id_supplier" class="col-sm-3 col-form-label">ID Distributor</label>
        <div class="col-sm-9">
            <input type="text" class="form-control form-control-sm <?= (form_error('id_supplier')) ? 'is-invalid' : ''; ?>" id="id_supplier" required autofocus name="id_supplier" placeholder="ID Supplier" value="<?= (set_value('id_supplier')) ? set_value('id_supplier') : $data->id_supplier; ?>">
            <div class="invalid-feedback">
                <?= form_error('id_supplier', '<p class="error-message">', '</p>'); ?>
            </div>
        </div>
    </div>
