...
class M_supplier extends CI_Model
{
    ...
    public $column_order    =  array(null, 'id_supplier', 'nama_supplier', 'alamat', 'telp', null); //set column field database untuk datatable order
    public $column_search   =  array('id_supplier', 'nama_supplier', 'alamat', 'telp'); //set column field database untuk datatable search
    public $order = array('id_supplier' => 'asc'); // default order
