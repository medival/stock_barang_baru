...
{
    public $select = array('p.id_penjualan AS id_penjualan', 'tgl_penjualan', 'count(id_barang) AS jumlah', 'SUM(qty * harga) AS total', 'p.id_user AS id_user', 'fullname', 'nama_pembeli'); //data yang akan diambil
    ...
    public $column_order    =  array(null, 'p.id_penjualan', 'tgl_penjualan', 'nama_pembeli', 'jumlah', 'total', 'fullname', null); //set column field database untuk datatable order
    ...
    // {
    //     $select = 'p.id_penjualan AS id_penjualan, tgl_penjualan, dp.qty AS qty, dp.harga AS harga, kode_barang, nama_barang, brand, fullname, u.id_user AS id_user, nama_pembeli, dpm.harga AS harga_beli';
